...
class Monitor():
    def __init__(self):
        ...
        self.turn = Value ('i', 0) #Para establecer los turnos
    
    def are_no_ped_carS(self):
        return self.npedestrian.value == 0 and self.ncarS.value == 0 and (self.ncarS_waiting.value == 0 or self.turn.value == 1) and (self.npedestrian_waiting.value == 0 or self.turn.value == 1)
 
    def are_no_ped_carN(self):
        return self.npedestrian.value == 0 and self.ncarN.value == 0 and (self.npedestrian_waiting.value == 0 or self.turn.value == 2) and (self.ncarN_waiting.value == 0 or self.turn.value == 2)
    ...
    def are_no_cars(self):
        return self.ncarN.value == 0 and self.ncarS.value == 0 and (self.ncarN_waiting.value == 0 or self.turn.value == 0) and (self.ncarS_waiting.value == 0 or self.turn.value == 0)
